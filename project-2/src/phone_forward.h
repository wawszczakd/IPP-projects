 ...
 * pewnego jego prefiksu, konkatenacja przekierowania z tego prefiksu oraz
 * pozostałej części numeru @p x jest równa @p num, to numer @p x należy do
 * wyniku wywołania @ref phfwdReverse z numerem @p num. Dodatkowo ciąg wynikowy
 * zawsze zawiera też numer @p num. Wynikowe numery są posortowane
 * leksykograficznie i się nie powtarzają. Jeśli podany napis nie reprezentuje
 * numeru, wynikiem jest pusty ciąg. Alokuje strukturę PhoneNumbers, która musi
 * być zwolniona za pomocą funkcji @ref phnumDelete.
 * @param[in] pf  – wskaźnik na strukturę przechowującą przekierowania numerów;
 * @param[in] num – wskaźnik na napis reprezentujący numer.
 * @return Wskaźnik na strukturę przechowującą ciąg numerów lub NULL, gdy nie
 *         udało się alokować pamięci.
 ...
 * Wyznacza posortowany leksykograficznie ciąg numerów taki, że numer @p x
 * należy do wynikowego ciągu wtedy i tylko wtedy, gdy wynik wywołania funkcji
 * @ref phfwdGet z parametrem @p x jest równy @p num.
 * @param[in] pf  – wskaźnik na strukturę przechowującą przekierowania numerów;
 * @param[in] num – wskaźnik na napis reprezentujący numer.
 * @return Wskaźnik na strukturę przechowującą ciąg numerów lub NULL, gdy nie
 *         udało się alokować pamięci.
